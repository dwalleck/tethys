...
**Diff estimate:** 7000 lines including retained native/mutation proof and diagnostic churn; the staged F17 repair reaches6,788 lines across102 files since S3a began. Existing production owner ranges remain unchanged and pass C13; this is a plan-size amendment, not an architecture or scope change.
