...
| P2 | Observed strategy transitions (`qualified_exact`×12) exceed the approved C3 amendment's predicted class (`same_crate`) | Spec | Informational | Yes (disclosed in audit.md:30-37; targets unchanged) | Accept (adjudicated) | Maintainer accepted 2026-07-12 pre-merge: the labels follow ADR-0003's band rationale (`use crate::X;` names the exact item) and the audit proved 0 target changes |
