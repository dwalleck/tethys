#!/usr/bin/env python3
"""
Check consistency across Tethys documentation and code.
"""
...
def check_source_generator_patterns():
    ...
    gen_file = Path('src/Tethys.MinimalEndpoints.ImprovedSourceGenerators/EndpointGeneratorImproved.cs')
...
def main():
    ...
    print("=== Tethys Consistency Check ===\n")
