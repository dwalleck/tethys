#!/usr/bin/env python3
"""
Export Tethys test tasks to GitHub issues format.
...
**Component**: Tethys.MinimalEndpoints
...
**Files to Modify**:
- `test/Tethys.MinimalEndpoints.ImprovedSourceGenerators.Tests/EquatableArrayTests.cs` (create)
...
**Files to Modify**:
- `test/Tethys.MinimalEndpoints.ImprovedSourceGenerators.Tests/ModelEqualityTests.cs` (create)
"""
...
**Files to Create**:
- `test/Tethys.MinimalEndpoints.ImprovedSourceGenerators.Tests/CacheabilityTests.cs`
...
def create_import_instructions(output_dir):
    ...
    with open(instructions_path, 'w') as f:
        f.write("""# GitHub Issues Import Instructions for Tethys
